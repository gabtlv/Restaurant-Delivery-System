package com.restaurant.cart.persistence;
...
public class MenuItem_CRUD {
    ...
    private static Connection getCon() throws Exception {
        ...
        String URL = "jdbc:mysql://" + System.getenv("DB_URL") + "/Menu_DB?useSSL=false&serverTimezone=UTC&allowPublicKeyRetrieval=true";
