...
public class BrowseServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String MENU_URL = "http://" + System.getenv("menuService") + "/MenuService/webresources/menu/all";
        ...
        // Call MenuService with JWT token
        try {
            Client client = ClientBuilder.newClient();
            String xml = client.target(MENU_URL)
        ...
        // Call CartService with JWT token
        try {
            Client client = ClientBuilder.newClient();
        ...
        System.out.println("DEBUG: MENU_URL = " + MENU_URL);
        System.out.println("DEBUG: menuItems size = " + menuItems.size());
